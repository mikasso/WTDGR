...
export default class BoardManager {
  ...
  createVertex(position){
    const vertex = this.vertexManager.create(this.layerManager.currentLayer, position)
  ...
  startPencil(position){
    const pencilDrawing = this.pencilManager.create(position, this.layerManager.currentLayer);
