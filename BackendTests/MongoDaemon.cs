...
namespace BackendTests
{
    public class MongoDaemon : IDisposable
    {
        ...
        public MongoDaemon()
        {
            ...
            this.mongoFolder = Path.Combine(this.assemblyFolder, $"C:\\Program Files\\MongoDB\\Server\\4.4\\bin\\");
        ...
        public string Query(string query)
        {
            ...
            var procQuery = new Process
            {
                StartInfo = new ProcessStartInfo
                {
                    ...
                    Arguments = string.Format("--host {0} --port {1} --quiet --eval \"{2}\" {3}", Host, Port, query,DbName),
